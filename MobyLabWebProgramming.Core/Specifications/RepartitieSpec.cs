...
/// </summary>
public sealed class RepartitieSpec : BaseSpec<RepartitieSpec, Repartitie>
{
    public RepartitieSpec(Guid id) : base(id)
    {
    }

    public RepartitieSpec(string cnp)
    {
        Query.Where(e => e.CNP == cnp);
    }
}